package com.inhealion.generator.presentation.device.adapter
...
class DiscoveryDeviceAdapter(val onClickAction: (DeviceUiModel) -> Unit) :
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        ...
        (holder as ViewHolder).viewBinding.apply {
            ...
            root.setOnClickListener { onClickAction(device) }
        }
    }
